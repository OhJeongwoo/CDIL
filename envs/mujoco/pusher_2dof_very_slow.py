...
class Pusher2DOFVerySlowCornerEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
        ...
        mujoco_env.MujocoEnv.__init__(self, 'pusher_very_slow_2dof.xml', 2)
        self.viewer = None
...
class Pusher2DOFVerySlowWallEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        ...
        self.reset_called = False
        utils.EzPickle.__init__(self)
        mujoco_env.MujocoEnv.__init__(self, 'pusher_2dof_very_slow.xml', 2)
        self.viewer = None
