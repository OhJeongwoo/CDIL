...
class Antv7_alignment(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.steps = 0
        ...
        mujoco_env.MujocoEnv.__init__(self, "ant_6legged_slow.xml", 5)
...
class Antv7_target(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.steps = 0
