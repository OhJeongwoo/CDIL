...
class Reacher2DOFFastCornerEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
        ...
        mujoco_env.MujocoEnv.__init__(self, 'reacher_2dof_fast.xml', 2)
        self.viewer = None
    ...
    def step(self, a):
        ...
        reward = 2.0 * (reward_dist + reward_ctrl)
...
class Reacher2DOFFastWallEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
