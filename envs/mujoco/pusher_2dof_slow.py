...
class Pusher2DOFSlowCornerEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
        ...
        mujoco_env.MujocoEnv.__init__(self, 'pusher_2dof_slow.xml', 2)
        self.viewer = None
...
class Pusher2DOFSlowWallEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
