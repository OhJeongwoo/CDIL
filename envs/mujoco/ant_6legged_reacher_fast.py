...
class Antv9_alignment(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.steps = 0
        ...
        mujoco_env.MujocoEnv.__init__(self, "ant_6legged_fast.xml", 5)
...
class Antv9_target(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.i_episode = 0
        self.steps = 0
