...
class Reacher2DOFDynamicsCornerEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
    ...
    def step(self, a):
        ...
        reward_ctrl = - np.square(a).sum() / self.dynamics_coeff
...
class Reacher2DOFDynamicsWallEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.steps = 0
        self.i_episode = 0
        scale = np.sqrt(2)
